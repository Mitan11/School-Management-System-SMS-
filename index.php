...
<header id="nav" class="shadow-sm  position-sticky top-0 z-3">
    <nav class="navbar navbar-expand-md bg-body-tertiary" id="nav">
        <div class="container-fluid">
            <!-- Brand name or logo -->
            <a class="navbar-brand fw-semibold" href="#Hero"><img class="rounded-circle" width="40" src="./Assets/imgs/GFA logo.png" alt=""></a>
                                                        ...
                                                        <div class="row gy-3 gy-md-4 overflow-hidden">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <input type="email" class="form-control" name="email"
                                                                    id="email" placeholder="name@example.com" required  autocomplete="on">
                                                            </div>
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <input type="password" class="form-control"
                                                                    name="password" id="password" value="" required  autocomplete="on">
                                                            </div>
                                                            <!-- Submit button -->
                                                            <div class="col-12">
                                                                <div class="d-grid">
...
<main class="position-fixed overflow-y-scroll" id="main" data-bs-spy="scroll" data-bs-target="#nav" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true">
                    ...
                    <div class="col-12 col-md-10 mx-auto card">
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                ...
                                <!-- Class input field -->
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="Sclasss" id="class" placeholder="11"
                ...
                <div class="mx-auto" style="max-width: 23rem;">
                    <div class="card testimonial-card">
                        <div class="avatar mx-auto white">
                            <!-- Teacher image -->
                            <img src="./Assets/imgs/teacher_1.jpg" class="rounded-circle img-fluid" alt="woman avatar">
                        </div>
                        <div class="card-body text-center">
                            <!-- Teacher name -->
